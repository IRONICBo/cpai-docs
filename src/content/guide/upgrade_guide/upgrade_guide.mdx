...
#### 6. **No Impact on Other Resources**
...
Visit the [CloudPilot AI Upgrade Page](https://github.com/cloudpilot-ai/examples/tree/main/upgrade) to download the latest upgrade script. Choose the appropriate script version based on your cluster environment.
...
By following these steps, your CloudPilot AI will be successfully upgraded to the latest version, benefiting from the newest optimizations and features.